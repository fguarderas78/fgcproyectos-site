...
export default function Page() {
  return (
    <div className="container py-12">
      <h1 className="text-3xl font-bold">ContÃ¡ctenos</h1>
      <p className="mt-2 text-slate-300">Â¿Quiere que seamos parte de su proyecto? EscrÃ­banos.</p>
      ...
      <form className="mt-8 grid gap-4 max-w-xl">
        ...
        <input className="border rounded-xl px-4 py-3 bg-slate-900 border-white/10 text-white placeholder:text-slate-400" placeholder="TelÃ©fono" name="telefono" />
      ...
      <div className="mt-10 text-sm text-slate-300">
        ...
        <p><strong>TelÃ©fono:</strong> +593 4 225 0482</p>
        <p><strong>DirecciÃ³n:</strong> C.C. Plaza Siete y Medio Of. 7 (Km. 7.5 VÃ­a a Daule)</p>
      </div>
    </div>
  );
}
