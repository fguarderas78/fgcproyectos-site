    ...
    <section>
      ...
      <div className="bg-white">
        <div className="container py-10 text-slate-800">
          ...
          <li><strong>Órdenes de trabajo y CMMS:</strong> Gestión digital de OT, priorización, trazabilidad de repuestos, tiempos y costos.</li>
          ...
          <li>Órdenes de trabajo estandarizadas (CMMS)</li>
